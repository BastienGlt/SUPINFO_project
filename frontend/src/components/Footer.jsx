            ...
            <div className="footer-inner">
                ...
                <div>
                    <p style={{ marginBottom: '0.5rem' }}>
                        <strong style={{ color: 'var(--primary)', fontFamily: 'Rajdhani, sans-serif' }}>SUPCONTENT</strong> — Réseau social gaming
                    </p>
                    <p>
                    ...
                    <p style={{ marginTop: '0.5rem' }}>
                        © {new Date().getFullYear()} SUPCONTENT — Tous droits réservés.
                    </p>
                </div>
            </div>
        </footer>
